...
const ActionButton = ({ icon: Icon, label, colorClass, onClick, link }) => {
    const Content = () => (
        <div className="bg-black border border-gray-800 rounded-3xl p-8 flex flex-col items-center justify-center gap-4 cursor-pointer hover:bg-gray-900 transition-all group shadow-lg hover:shadow-xl hover:translate-y-[-2px]">
    ...
    return (
        <div className="space-y-8 pb-12">
            ...
            <div className="flex items-center space-x-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-text-main uppercase">Financial Center</h1>
                    <p className="text-sm font-bold text-text-muted uppercase">Ecosystem Liquidity & Portfolio Overview</p>
                </div>
            </div>
